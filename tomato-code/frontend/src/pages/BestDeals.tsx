...
const dealLabels = ["Flat 30% off", "Free delivery", "Combo meals", "Top picks"];
    ...
    <div className="mx-auto max-w-7xl px-4 py-6">
      <div className="mb-5">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Restaurants with offers and high-value picks near your location.
        </p>
      </div>
            ...
            return (
              <div key={res._id} className="relative">
                <div className="absolute left-3 top-3 z-10 rounded-full bg-[#E23744] px-3 py-1 text-xs font-bold text-white shadow">
                  {dealLabels[index % dealLabels.length]}
                </div>
                <RestaurantCard
                  id={res._id}
                  name={res.name}
